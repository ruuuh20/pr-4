      ...
      <div className="container">
        <div className="row">
          <div className="logo-footer">
            <svg class="css-oylsik" viewBox="0 0 184 25" fill="#fff">
        ...
        <div className="row">
          <div className="col col-2-w footer-section">
          ...
          <div className="col col-2-w footer-section">
            {" "}
            <h3 className="section-label">Arts</h3>
            <ul>
              <li>
          ...
          <div className="col col-2-w footer-section">
            {" "}
            <h3 className="section-label">Living</h3>
            <ul>
              <li>
                <a href="#">At Home</a>
              </li>
